...
// *apperr.AppError (e.g. "категория не найдена"), falling back to a
// generic message for anything else so a raw Go/driver error never leaks
// to the page.
