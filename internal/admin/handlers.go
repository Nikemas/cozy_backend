...
type handlers struct {
	...
	// enriches an order with (customer phone, delivery address, pickup
	// point address) — see orders.go's adminOrdersService for exactly
	// which *orders.Service methods are used.
