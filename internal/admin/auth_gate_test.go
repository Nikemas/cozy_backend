...
func TestNavItemsForRole(t *testing.T) {
	...
	wantOwner := []string{"orders", "products", "stock", "categories", "reports", "broadcasts", "points", "delivery", "staff", "audit"}
	...
	wantManager := []string{"orders", "products", "stock", "categories", "reports", "broadcasts"}
