...
func TestAuditRowVM(t *testing.T) {
	...
	vm := auditRowVM(audit.Row{At: at, StaffName: "Айгерим", Action: audit.ActionOrderStatus, EntityType: audit.EntityOrder,
	...
	vm = auditRowVM(audit.Row{At: at, Action: audit.ActionStockUpdate, EntityType: audit.EntityStock, EntityID: "v1",
