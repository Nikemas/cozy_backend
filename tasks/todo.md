...
- [ ] **Task 2** — Товары (список+форма+импорт). В работе (параллельный агент). [детали](plan.md#task-2-товары--список-форма-импорт)
- [ ] **Task 3** — Заказы (список+детально). В работе (параллельный агент). [детали](plan.md#task-3-заказы--список-и-детально)
- [ ] **Task 4** — Отчёты. В работе (параллельный агент). [детали](plan.md#task-4-отчёты)
- [ ] **Task 5** — Точки продаж + Сотрудники. В работе (параллельный агент). [детали](plan.md#task-5-точки-продаж--сотрудники)
